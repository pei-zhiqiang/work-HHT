...
#define USE_SPI_DMA_MODE          1       /**< 使用DMA通讯模式 */
...
/* 各flash片选操作表 */
static SPI_FLASH_CS_GPIO_CTL_Typedef_t SPI_Cs_Ctl_Table[] =
{
  [SFUD_GD25Q64C_DEVICE0_INDEX] = {
    .Enable_CS_Gpio = HAL_Flash0_CS_GPIO_ENABLE,
    .Disable_CS_Gpio = HAL_CS_GPIO_DISABLE,
  },
  [SFUD_GD25Q64C_DEVICE1_INDEX] = {
    .Enable_CS_Gpio = HAL_Flash1_CS_GPIO_ENABLE,
    .Disable_CS_Gpio = HAL_CS_GPIO_DISABLE,
  },
};
...
sfud_err sfud_spi_port_init(sfud_flash *flash)
{
  ...
  flash->spi.lock = SPI_lock;
  flash->spi.unlock = SPI_unlock;
  flash->spi.user_data = &SPI_Cs_Ctl_Table[flash->index];
